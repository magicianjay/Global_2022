...
public class PLAYER_Base : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _myPlayerBody.Initialize(this);
        _myPlayerWeapon.Initialize(this);
    }

    public virtual void Update()
    {
        if (Input.GetAxis($"PLAYER{_idxPlayer}_HorizontalAxis_LeftStick") !=0|| Input.GetAxis($"PLAYER{_idxPlayer}_VerticalAxis_LeftStick") != 0)
        {
        ...
        {
            _myPlayerMovement.Movement_Lookat($"PLAYER{_idxPlayer}_HorizontalAxis_LeftStick",$"PLAYER{_idxPlayer}_VerticalAxis_LeftStick");
        }
